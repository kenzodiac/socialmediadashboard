        ...
        <div className="background" data-theme={theme}>
            ...
            <Container style={{maxWidth: "1100px"}}>
                ...
                <Row style={{minHeight: "90px"}}>
                    <Col xs={12} sm={8} className="pt-3" style={{minHeight: "90px"}}>
                ...
                <Row className="g-4">
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Page Views'} logo={facebookIcon} num={'87'} arrow={upIcon} color={'followers-change increase'} percentNum={'3'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Likes'} logo={facebookIcon} num={'52'} arrow={downIcon} color={'followers-change decrease'} percentNum={'2'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Likes'} logo={instaIcon} num={'5462'} arrow={upIcon} color={'followers-change increase'} percentNum={'2257'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Profile Views'} logo={instaIcon} num={'52k'} arrow={upIcon} color={'followers-change increase'} percentNum={'1375'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Retweets'} logo={twitterIcon} num={'117'} arrow={upIcon} color={'followers-change increase'} percentNum={'303'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Likes'} logo={twitterIcon} num={'507'} arrow={upIcon} color={'followers-change increase'} percentNum={'553'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Likes'} logo={ytIcon} num={'107'} arrow={downIcon} color={'followers-change decrease'} percentNum={'19'}/>
                    </Col>
                    <Col className="overview-cols" lg={3} md={4} sm={6} xs={12}>
                        <OverviewComponent title={'Total Views'} logo={ytIcon} num={'1407'} arrow={downIcon} color={'followers-change decrease'} percentNum={'12'}/>
                    </Col>
                </Row>
            </Container>
            </div>
